...
<div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            @endif
            <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ route('post.store') }}">
                <div class="form-group">
                    {{ csrf_field() }}
                    <label class="control-label col-lg-2 col-xs-12">Tiêu đề bài viết</label>
                    <div class="col-lg-10 col-xs-12">
                        <input type="text" id="post-name" name="name" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-xs-12">
                        <textarea rows="3" cols="3" class="form-control" name="description" placeholder="Mô tả bài viết"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-12 col-xs-12">
                        <textarea class="my-editor" id="editor" name="content"></textarea>
                    </div>
                </div>
